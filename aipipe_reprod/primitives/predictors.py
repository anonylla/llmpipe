from sklearn.linear_model import LassoCV, PassiveAggressiveClassifier, RidgeClassifier, RidgeClassifierCV, SGDClassifier
from sklearn.ensemble import (RandomForestClassifier, AdaBoostClassifier, BaggingClassifier, ExtraTreesClassifier,
    GradientBoostingClassifier, AdaBoostRegressor, BaggingRegressor)
...
from sklearn.linear_model import LogisticRegression, LogisticRegressionCV, ARDRegression
...
class PredictorPrimitive(Primitive):
    def transform(self, train_x: pd.DataFrame, train_y: pd.Series, test_x: pd.DataFrame) -> pd.Series:
        raise NotImplementedError

class RandomForestClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class AdaBoostClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class BaggingClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class BernoulliNBClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class DecisionTreeClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class ExtraTreesClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class GaussianNBClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class GaussianProcessClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class GradientBoostingClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class KNeighborsClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class LinearDiscriminantAnalysisPrim(PredictorPrimitive):
    def __init__(self):
...
class LinearSVCPrim(PredictorPrimitive):
    def __init__(self):
...
class LogisticRegressionPrim(PredictorPrimitive):
    def __init__(self):
    ...
    def transform(self, train_x, train_y, test_x):
        ...
        model.fit(train_x[num_cols].fillna(0).replace([np.inf, -np.inf], 0), train_y)
        pred_y = model.predict(test_x[num_cols].fillna(0).replace([np.inf, -np.inf], 0))
        return pred_y

class NearestCentroidPrim(PredictorPrimitive):
    def __init__(self):
...
class PassiveAggressiveClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class RidgeClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class RidgeClassifierCVPrim(PredictorPrimitive):
    def __init__(self):
...
class SGDClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class SVCPrim(PredictorPrimitive):
    def __init__(self):
...
class BalancedRandomForestClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class EasyEnsembleClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class RUSBoostClassifierPrim(PredictorPrimitive):
    def __init__(self):
...
class ARDRegressionPrim(PredictorPrimitive):
    def __init__(self):
...
class AdaBoostRegressorPrim(PredictorPrimitive):
    def __init__(self):
...
class BaggingRegressorPrim(PredictorPrimitive):
    def __init__(self):
